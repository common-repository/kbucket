...
var $kbj = $;
$kbj(function($) {
	//kbObj = dynamicLocalizationDataWidget;
	//console.log("Mayra k "+kbObj.blog_id);
	...
	setTimeout(function () {
		...
		if ($kbj(window).width() > 767) 
		//console.log("_initMasonryGrid "); 
	_initMasonryGrid();
	}, 500);
...
$kbj(document).on('click','.kb-item .kb-read-more-link',function(e){
	...
	jQuery(document).on("click", ".share_modal_wrapper .show-more", function() {
	  ...
	  jQuery(document).on("click", ".share_modal_wrapper .show-less", function() {
